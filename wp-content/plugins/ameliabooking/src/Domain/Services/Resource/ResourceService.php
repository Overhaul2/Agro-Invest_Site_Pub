...
class ResourceService extends AbstractResourceService
{
     ...
     * @throws InvalidArgumentException
     */
    private function getResourcedIntervals($resources, $appointments)
    {
        $resourcesIntervals = [];
     ...
     * @throws InvalidArgumentException
     */
    private function manageProvidersWithResources($providersResources, $appointments, $providers, $excludeAppointmentId)
    {
